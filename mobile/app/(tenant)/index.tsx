...
function createStyles(colors: ThemeColors) {
  return StyleSheet.create({
    ...
    emptyEmail: { fontWeight: '700', color: colors.text },
    ...
    nextLabel: { fontSize: 11, color: colors.placeholder, fontWeight: '600', letterSpacing: 0.5, marginBottom: 4 },
    nextAmountRow: { flexDirection: 'row', alignItems: 'center', gap: 10, flexWrap: 'wrap' },
    nextAmount: { fontSize: 34, fontWeight: '800', color: colors.text },
    ...
    nextDue: { fontSize: 14, color: colors.textSecondary, marginTop: 6, marginBottom: 18 },
    ...
    quickLabel: { fontSize: 10, color: colors.placeholder, fontWeight: '600', letterSpacing: 0.5, marginBottom: 6 },
    quickValue: { fontSize: 16, fontWeight: '700', color: colors.text },
    quickLink: { fontSize: 12, color: colors.placeholder, marginTop: 4 },
    progressTrack: {
      marginTop: 8,
      height: 4,
    ...
    timelineMonth: { fontSize: 13, fontWeight: '700', color: colors.text, flex: 1 },
    timelineAmount: { fontSize: 15, fontWeight: '800', color: colors.text },
    timelineDueText: { fontSize: 11, color: colors.textMuted, marginTop: 3, flex: 1 },
